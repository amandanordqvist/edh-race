...
export const en: Dictionary = {
  ...
  home: {
    ...
    statsLead: 'Edh Racing’s quickest quarter-mile pass — Santa Pod.',
    stats: {
      quarter: { value: '5.74s', label: 'Quarter mile (402 m)' },
      topSpeed: { value: '415 km/h', label: 'Top speed quarter mile' },
      eighth: { value: '3.80s', label: 'Eighth mile' },
